...
class BEAMSAdminSettings(Document):
	def validate(self):
		self.update_vehicle_fuel_uom()
	
	def update_vehicle_fuel_uom(self):
		"""Create or update Vehicle Doctype fuel_uom Property Setter from BEAMS Admin Setting."""

		fuel_uom = self.default_fuel_uom
