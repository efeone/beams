                        ...
                        fields: [
                            {
                                ...
                                reqd: 1,
                                onchange: function() {
                                    console.log(dialog.fields_dict.equipments.grid.data)
                                    console.log(dialog.get_value("equipments")[0])
                                    dialog.fields_dict.equipments.grid.data.forEach((item, i) => {
                                      console.log(item)
                                      frappe.call({
                                          ...
                                          callback: function(r) {
                                              if (r.message) {
                                                  console.log(r.message[item.item])
                                                  const available_qty = r.message[item.item] || 0;
                                                  console.log(item.idx)
                                                  console.log(dialog.fields_dict.equipments.grid.data[item.idx-1])
                                                  // dialog.fields_dict.equipments.grid.data[item.idx-1].set_value("available_quantity", available_qty)
                                                  // dialog.set_value(`equipments.item`)
                                              }
                                          }
                                      });
                                    });
