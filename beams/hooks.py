...
fixtures = [
    {"dt": "Workflow", "filters": [
        ...
        "Equipment Hire Request","Trip Sheet","Technical Request Workflow","Award Record Workflow","Employee Travel Request","Digital Library Workflow"]]
    ]},
    {"dt": "Workflow State", "filters": [
        ...
        "Pending CEO Approval", "Pending CEO Final Approval","Closed","Reviewed","Pending","Applied ","Nominated ","Awarded","Transferred","Returned" ]]
    ]},
